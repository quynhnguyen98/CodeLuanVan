            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6">
                    <div class="login-content bg-white p-30 box-shadow">
                        ...
                        <form action="{{URL::to('/resest-pass1/check')}}" method="post">@csrf
                            <div class="form-group">
                                <input type="password" name="passwordold" class="form-control" id="exampleInputEmail1" placeholder="Nhập mật khẩu cũ" required>
                            </div>
                            <div class="form-group">
